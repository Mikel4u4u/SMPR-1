...
то минимум среднего риска достигается алгоритмом</p>
  ...
  <p>Как видно из рисунка предположение, что признаки были независимыми нормально распределенными было действительно &#171наивным&#187 потомучто ошибка классификации составила почти 9%.</p>
