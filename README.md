...
P<sub>y</sub> = P(y) называются априорными вероятностями классов.</p>
 ...
  <p><i>Функционалом среднего риска</i> называется ожидаемая величина потери при классификации объектов алгоритмом a:</p>
  ...
  <p><i>Оптимальное байесовское решающее правило:</p>
  <p></i>Если известны априорные вероятности P<sub>y</sub> и функции правдоподобия p<sub>y</sub>(x), то минимум среднего риска R(a) достигается алгоритмом</p>
