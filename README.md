...
<body>
  ...
  <p><a href="#Naivnyy_bayesophskiy_klassiphikator">3.1. Наивный байесовский классификатор</a></p>
...
P<sub>y</sub> = P(y) называются априорными вероятностями классов.</p>
 ...
  <p><i>Функционалом среднего риска</i> называется ожидаемая величина потери при классификации объектов алгоритмом a:</p>
  ...
  ### 2.1. 3.1. Наивный байесовский классификатор  <a name="Naivnyy_bayesophskiy_klassiphikator"></a>
