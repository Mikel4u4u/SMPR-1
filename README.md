...
то минимум среднего риска достигается алгоритмом</p>
  ...
  <p>Листинг скрипта на R реализующий наивный байесовский классификатор на любимых всеми студентами информатиками ирисах фишера:<a href='https://github.com/PavlyukovVladimir/SMPR/blob/master/scripts/NNBayes.R'>NNBayes.R</a></p>
</body>
</html>
